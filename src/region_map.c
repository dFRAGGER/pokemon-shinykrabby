...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_10_POKECENTER] = {MAP_GROUP(MAP_ROUTE10_FRLG), MAP_NUM(MAP_ROUTE10_FRLG), HEAL_LOCATION_ROUTE10},
    ...
    [MAPSEC_ROUTE_10] = {MAP_GROUP(MAP_ROUTE10_FRLG), MAP_NUM(MAP_ROUTE10_FRLG), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_15] = {MAP_GROUP(MAP_ROUTE15_FRLG), MAP_NUM(MAP_ROUTE15_FRLG), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ERPUS_CITY] = {MAP_GROUP(MAP_ERP_CITY), MAP_NUM(MAP_ERP_CITY), HEAL_LOCATION_ERP_CITY},
    [MAPSEC_MAASJE] = {MAP_GROUP(MAP_MAASJE), MAP_NUM(MAP_MAASJE), HEAL_LOCATION_MAASJE},
    [MAPSEC_MIST_CITY] = {MAP_GROUP(MAP_MIST_CITY), MAP_NUM(MAP_MIST_CITY), HEAL_LOCATION_MIST_CITY},
    [MAPSEC_LIONS_ARCH_CITY] = {MAP_GROUP(MAP_LIONSARCH_CITY), MAP_NUM(MAP_LIONSARCH_CITY), HEAL_LOCATION_LIONSARCH_CITY},
    [MAPSEC_SILTROOT_TOWN] = {MAP_GROUP(MAP_SILTROOT_TOWN), MAP_NUM(MAP_SILTROOT_TOWN), HEAL_LOCATION_SILTROOT_TOWN},
};
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_ERPUS_CITY:
        return FlagGet(FLAG_VISITED_ERP_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MAASJE:
        return FlagGet(FLAG_VISITED_MAASJE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MIST_CITY:
        return FlagGet(FLAG_VISITED_MIST_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LIONS_ARCH_CITY:
        return FlagGet(FLAG_VISITED_LIONSARCH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SILTROOT_TOWN:
        return FlagGet(FLAG_VISITED_SILTROOT_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
