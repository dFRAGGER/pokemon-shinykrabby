...
// ShinyKrabby: stock tilesets referenced by ported custom maps, normally
// excluded from the HNS build - re-added individually to avoid pulling in
// the entire stock Hoenn tileset library.
