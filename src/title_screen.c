...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/shiny_krabby.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/shiny_krabby.bin.smolTM");
