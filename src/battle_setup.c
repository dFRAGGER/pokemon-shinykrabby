...
static const struct {
    ...
    // ShinyKrabby custom maps (ported)
    {MAP_BALKUM_TOWN, BATTLE_ENVIRONMENT_DESERT},
    {MAP_BATCAVE, BATTLE_ENVIRONMENT_CAVE},
    {MAP_BIKE_PARK, BATTLE_ENVIRONMENT_MOUNTAIN},
    {MAP_BIKE_ROUTE_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_BIKE_SHOP_JAOUAD, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_CAVE_CORRIDOR, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_CAVE_HALLWAY_JARI, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_CRABHILL_ENTRANCE, BATTLE_ENVIRONMENT_CAVE},
    {MAP_DEEP_CLOUDFOREST_FACULTY_ANCIENT_GROTTO, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_DEEP_CLOUD_FOREST_FACULTY_GORGE, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_DEEP_CLOUD_FOREST_FACULTY_GORGE_RESTORED, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_EAST_LION_MOUNTAIN, BATTLE_ENVIRONMENT_SNOW},
    {MAP_EAST_LION_MOUNTAIN_FACULTY_MINING_CAVE, BATTLE_ENVIRONMENT_RED_CAVE},
    {MAP_EAST_LION_MOUNTAIN_FACULTY_MINING_CAVE_B1F, BATTLE_ENVIRONMENT_RED_CAVE},
    {MAP_ERP_CITY, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ERPUS_CITY_BARRY_HOUSE_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ERPUS_CITY_BARRY_HOUSE_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ERPUS_CITY_HOUSE3_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ERPUS_CITY_START_HOUSE_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ERPUS_CITY_START_HOUSE_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_HEZIK_TOWN, BATTLE_ENVIRONMENT_GRASS},
    {MAP_INDOOR_BERNRODE_GENERAL, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_INDOOR_MAASJE_BEEKEEPER_GEURTS, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_INDOOR_MAASJE_HOME1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_INDOOR_MAASJE_HOME2, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_INDOOR_MAASJE_JAKUB_HOME, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ISLAND_MECHERCHAR, BATTLE_ENVIRONMENT_SAND},
    {MAP_ISLAND_OHIANA, BATTLE_ENVIRONMENT_SAND},
    {MAP_LAB_JARI_INDOOR, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LAB_JARI_INDOOR_BASEMENT_STAIRS1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LAB_JARI_INDOOR_F0, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LAB_JARI_INDOOR_STORAGE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONARCHS_CITY_INDOOR_MART, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LION_MOUNTAIN_CAVE_SYSTEM_ENTRANCE, BATTLE_ENVIRONMENT_RED_CAVE},
    {MAP_LIONSARCH_CITY, BATTLE_ENVIRONMENT_SNOW},
    {MAP_LIONSARCH_CITY_INDOOR_GYM, BATTLE_ENVIRONMENT_SNOW_CAVE},
    {MAP_LIONSARCH_CITY_INDOOR_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_HOUSE2, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_HOUSE3, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_HOUSE4, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_PETER_BASEMENT_PARTY, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_PETER_HOUSE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_INDOOR_VISITOR_CENTER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_POKEMON_CENTER_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_POKEMON_CENTER_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_STEEL_FACTORY, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_STEEL_FACTORY_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_LIONSARCH_CITY_STEEL_FACTORY_B1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MAASJE, BATTLE_ENVIRONMENT_GRASS},
    {MAP_MAASJE_COASTAL_CAVE1, BATTLE_ENVIRONMENT_CAVE},
    {MAP_MAASJE_COASTAL_CAVE2, BATTLE_ENVIRONMENT_CAVE},
    {MAP_MAASJE_COASTAL_CAVE3, BATTLE_ENVIRONMENT_CAVE},
    {MAP_MAASJE_GYM, BATTLE_ENVIRONMENT_GYM},
    {MAP_MAASJE_GYM_BASEMENT, BATTLE_ENVIRONMENT_GYM},
    {MAP_MAASJE_MART, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MAASJE_POKEMON_CENTER_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MAASJE_POKEMON_CENTER_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSH_DUKE_CITY, BATTLE_ENVIRONMENT_GRASS},
    {MAP_MARSHDUKE_INDOOR_CATHEDRAL_GARDEN_GATEHOUSE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_CHATEDRAL, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_GARDEN, BATTLE_ENVIRONMENT_GRASS},
    {MAP_MARSHDUKE_INDOOR_GARDEN_CEMETERY, BATTLE_ENVIRONMENT_GRASS},
    {MAP_MARSHDUKE_INDOOR_GARDEN_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_GYM, BATTLE_ENVIRONMENT_GYM},
    {MAP_MARSHDUKE_INDOOR_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE1_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE2, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE3, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE4, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE5, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_HOUSE5_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_POKEMON_CENTER_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_POKEMON_CENTER_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_RESEARCH_CENTER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_RESEARCH_CENTER_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_TOWER1_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_TOWER1_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUKE_INDOOR_TOWER1_3F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MARSHDUK_INDOOR_MART, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MIST_CITY, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_MISTCITY_INDOOR_FACULTY_SYMPATHIZER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_INDOOR_GYM, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_INDOOR_MUSHROOM_SHOP, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_INDOOR_OLD_STORYTELLER_CABIN, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_INDOOR_PATTERN_FINDER_FATHER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_INDOOR_WOODWORK_SHOP, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_MART, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_POKEMON_CENTER_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_POKEMON_CENTER_2F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_RESEARCH_CENTER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_MISTCITY_RESEARCH_CENTER_ENTRANCE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE01, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE011, BATTLE_ENVIRONMENT_SAND},
    {MAP_ROUTE012, BATTLE_ENVIRONMENT_SAND},
    {MAP_ROUTE013, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE013_2, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE013_ESTUARY, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE014, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE014_ESTUARY, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE016, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE016_ELDWOOD_ENTRANCE, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE017, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE018, BATTLE_ENVIRONMENT_DESERT},
    {MAP_ROUTE019, BATTLE_ENVIRONMENT_DESERT},
    {MAP_ROUTE01_FOREST, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE020, BATTLE_ENVIRONMENT_DESERT},
    {MAP_ROUTE021, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE022, BATTLE_ENVIRONMENT_MOUNTAIN},
    {MAP_ROUTE023, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE02_INDOOR_RANGER_HOUSE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE03, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_ROUTE04, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_ROUTE04_CENTER_CAVE, BATTLE_ENVIRONMENT_CAVE},
    {MAP_ROUTE05, BATTLE_ENVIRONMENT_SNOW},
    {MAP_ROUTE06, BATTLE_ENVIRONMENT_SNOW},
    {MAP_ROUTE06_UPANA_CAVE_MAIN_ROOM, BATTLE_ENVIRONMENT_CAVE},
    {MAP_ROUTE06_UPANA_CAVE_RIVER_ROOM_B1F, BATTLE_ENVIRONMENT_CAVE},
    {MAP_ROUTE06_UPANA_CAVE_WEST_ENTRANCE, BATTLE_ENVIRONMENT_CAVE},
    {MAP_ROUTE07, BATTLE_ENVIRONMENT_SAND},
    {MAP_ROUTE09_DEEP_FOREST_CORE, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_ROUTE09_SECRET_FIORD, BATTLE_ENVIRONMENT_GRASS},
    {MAP_ROUTE09_SECRET_WATER_SOURCE, BATTLE_ENVIRONMENT_LONG_GRASS},
    {MAP_ROUTE10_SK, BATTLE_ENVIRONMENT_SAND},
    {MAP_ROUTE14_ESTUARY_INDOOR_BOATHOUSE, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE14_ESTUARY_INDOOR_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE14_ESTUARY_INDOOR_HOUSE2, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE14_ESTUARY_INDOOR_HOUSE3, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE14_ESTUARY_INDOOR_HOUSE4, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE14_INDOOR_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE15_SK, BATTLE_ENVIRONMENT_SAND},
    {MAP_ROUTE16_INDOOR_HOUSE1, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_ROUTE16_INDOOR_HOUSE2, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN, BATTLE_ENVIRONMENT_SAND},
    {MAP_SILTROOT_TOWN_INDOOR_ALI_APOTHECARY, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN_INDOOR_FACULTY_DEFECTOR, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN_INDOOR_HEALER, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN_INDOOR_HOUSE4, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN_INDOOR_POKECENTER_1F, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_SILTROOT_TOWN_INDOOR_SHED, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_WEST_LION_MOUNTAIN, BATTLE_ENVIRONMENT_SNOW},
    {MAP_WEST_LION_MOUNTAIN_CABLE_CAR, BATTLE_ENVIRONMENT_BUILDING},
    {MAP_WEST_LION_MOUNTAIN_SNOW_TOP, BATTLE_ENVIRONMENT_SNOW},
};
