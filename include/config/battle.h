...
#define B_FLAG_NO_CATCHING          B_FLAG_NO_CATCHING     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           B_FLAG_NO_RUNNING    // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
