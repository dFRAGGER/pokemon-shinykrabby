...
#define NUM_SNOWFLAKE_SPRITES_LIGHT    6
#define NUM_SNOWFLAKE_SPRITES_STANDARD 16
#define NUM_SNOWFLAKE_SPRITES_HEAVY    40
#define NUM_SNOWFLAKE_SPRITES_BLIZZARD 44
#define NUM_SNOWFLAKE_SPRITES          NUM_SNOWFLAKE_SPRITES_STANDARD
