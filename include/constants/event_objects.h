...
#define OBJ_EVENT_GFX_BLAINE_SK                  548
#define OBJ_EVENT_GFX_BLUE_SK                    549
#define OBJ_EVENT_GFX_BUGSY_SK                   550
#define OBJ_EVENT_GFX_ERIKA_SK                   551
#define OBJ_EVENT_GFX_FALKNER_SK                 552
#define OBJ_EVENT_GFX_GIOVANNI_SK                553
#define OBJ_EVENT_GFX_SABRINA_SK                 554
#define OBJ_EVENT_GFX_WHITNEY_SK                 555
#define OBJ_EVENT_GFX_BROCK_SK                   561
#define OBJ_EVENT_GFX_JANINE_SK                  575
#define OBJ_EVENT_GFX_KOGA_SK                    576
#define OBJ_EVENT_GFX_MISTY_SK                   584
#define OBJ_EVENT_GFX_MORTY_SK                   585
#define OBJ_EVENT_GFX_NINJA_BOY_SK               587
#define OBJ_EVENT_GFX_POKEKID_SK                 597
#define OBJ_EVENT_GFX_PSYCHIC_F_SK               598
#define OBJ_EVENT_GFX_SAGE_SK                    605
#define OBJ_EVENT_GFX_SKIER_F_SK                 608
#define OBJ_EVENT_GFX_SKIER_M_SK                 609
#define OBJ_EVENT_GFX_TWINS_SK                   610
#define OBJ_EVENT_GFX_VETERAN_SK                 611
#define OBJ_EVENT_GFX_AARON_DP                   615
#define OBJ_EVENT_GFX_ACE_TRAINER_F_DP           616
#define OBJ_EVENT_GFX_ACE_TRAINER_M_DP           617
#define OBJ_EVENT_GFX_ACE_TRAINER_SNOW_M_DP      618
#define OBJ_EVENT_GFX_BARRY_DP                   619
#define OBJ_EVENT_GFX_BATTLE_GIRL_DP             620
#define OBJ_EVENT_GFX_BEAUTY_DP                  621
#define OBJ_EVENT_GFX_BERTHA_DP                  622
#define OBJ_EVENT_GFX_BLACK_BELT_DP              623
#define OBJ_EVENT_GFX_BREEDER_F_DP               624
#define OBJ_EVENT_GFX_BUG_CATCHER_DP             625
#define OBJ_EVENT_GFX_BYRON_DP                   626
#define OBJ_EVENT_GFX_CAMPER_DP                  627
#define OBJ_EVENT_GFX_CHARON_DP                  628
#define OBJ_EVENT_GFX_CHERYL_DP                  629
#define OBJ_EVENT_GFX_COWGIRL_DP                 630
#define OBJ_EVENT_GFX_CRASHER_WAKE_DP            631
#define OBJ_EVENT_GFX_CYNTHIA_DP                 632
#define OBJ_EVENT_GFX_CYRUS_DP                   633
#define OBJ_EVENT_GFX_DRAGON_TAMER_DP            634
#define OBJ_EVENT_GFX_FANTINA_DP                 635
#define OBJ_EVENT_GFX_FISHERMAN_DP               636
#define OBJ_EVENT_GFX_GALACTIC_GRUNT_F_DP        637
#define OBJ_EVENT_GFX_GALACTIC_GRUNT_M_DP        638
#define OBJ_EVENT_GFX_GENTLEMAN_DP               639
#define OBJ_EVENT_GFX_HIKER_DP                   640
#define OBJ_EVENT_GFX_JUPITER_DP                 641
#define OBJ_EVENT_GFX_LADY_DP                    642
#define OBJ_EVENT_GFX_LOOKER_DP                  643
#define OBJ_EVENT_GFX_LUCIAN_DP                  644
#define OBJ_EVENT_GFX_MARLEY_DP                  645
#define OBJ_EVENT_GFX_MARS_DP                    646
#define OBJ_EVENT_GFX_MAYLENE_DP                 647
#define OBJ_EVENT_GFX_MIRA_DP                    648
#define OBJ_EVENT_GFX_OFFICER_DP                 649
#define OBJ_EVENT_GFX_PAINTER_DP                 650
#define OBJ_EVENT_GFX_PALMER_DP                  651
#define OBJ_EVENT_GFX_PARASOL_LADY_DP            652
#define OBJ_EVENT_GFX_PICNICKER_DP               653
#define OBJ_EVENT_GFX_POKE_KID_DP                654
#define OBJ_EVENT_GFX_POKE_RANGER_F_DP           655
#define OBJ_EVENT_GFX_POKE_RANGER_M_DP           656
#define OBJ_EVENT_GFX_POKEFAN_F_DP               657
#define OBJ_EVENT_GFX_POKEFAN_M_DP               658
#define OBJ_EVENT_GFX_PROF_ROWAN_DP              659
#define OBJ_EVENT_GFX_PSYCHIC_M_DP               660
#define OBJ_EVENT_GFX_RANCHER_DP                 661
#define OBJ_EVENT_GFX_RICH_BOY_DP                662
#define OBJ_EVENT_GFX_RICH_LADY_DP               663
#define OBJ_EVENT_GFX_ROCKER_DP                  664
#define OBJ_EVENT_GFX_ROUGHNECK_DP               665
#define OBJ_EVENT_GFX_RUIN_MANIAC_DP             666
#define OBJ_EVENT_GFX_SAILOR_DP                  667
#define OBJ_EVENT_GFX_SATURN_DP                  668
#define OBJ_EVENT_GFX_SCIENTIST_DP               669
#define OBJ_EVENT_GFX_SKIER_F_DP                 670
#define OBJ_EVENT_GFX_SKIER_M_DP                 671
#define OBJ_EVENT_GFX_SOCIALITE_DP               672
#define OBJ_EVENT_GFX_SUPERNERD_DP               673
#define OBJ_EVENT_GFX_SWIMMER_F_DP               674
#define OBJ_EVENT_GFX_SWIMMER_F2_DP              675
#define OBJ_EVENT_GFX_SWIMMER_M_DP               676
#define OBJ_EVENT_GFX_SWIMMER_M2_DP              677
#define OBJ_EVENT_GFX_VOLKNER_DP                 678
#define OBJ_EVENT_GFX_WAITER_DP                  679
#define OBJ_EVENT_GFX_WAITRESS_DP                680
#define OBJ_EVENT_GFX_WORKER_DP                  681
#define OBJ_EVENT_GFX_YOUNG_COUPLE_F_DP          682
#define OBJ_EVENT_GFX_YOUNG_COUPLE_M_DP          683
#define OBJ_EVENT_GFX_YOUNGSTER_DP               684
#define OBJ_EVENT_GFX_ACE_TRAINER_F_SNOW_SK      685
#define OBJ_EVENT_GFX_ACE_TRAINER_M_SK           686
#define OBJ_EVENT_GFX_ACE_TRAINER_M_SNOW_SK      687
#define OBJ_EVENT_GFX_BATTLE_GIRL_SK             688
#define OBJ_EVENT_GFX_BREEDER_F_SK               689
#define OBJ_EVENT_GFX_BUG_CATCHER_SK             690
#define OBJ_EVENT_GFX_CLERK2_SK                  691
#define OBJ_EVENT_GFX_CLERK_SK                   692
#define OBJ_EVENT_GFX_COWGIRL_SK                 693
#define OBJ_EVENT_GFX_CUE_BALL_SK                694
#define OBJ_EVENT_GFX_DRAGON_TAMER_SK            695
#define OBJ_EVENT_GFX_FIREBREATHER_SK            696
#define OBJ_EVENT_GFX_FISHERMAN_SK               697
#define OBJ_EVENT_GFX_GAMER_SK                   698
#define OBJ_EVENT_GFX_GENTLEMAN_SK               699
#define OBJ_EVENT_GFX_GIRL_SK                    700
#define OBJ_EVENT_GFX_GUARD_SK                   701
#define OBJ_EVENT_GFX_HIKER_SK                   702
#define OBJ_EVENT_GFX_LASS_SK                    703
#define OBJ_EVENT_GFX_LEAF_SK                    704
#define OBJ_EVENT_GFX_MAN2_SK                    705
#define OBJ_EVENT_GFX_MAN3_SK                    706
#define OBJ_EVENT_GFX_MAN4_SK                    707
#define OBJ_EVENT_GFX_MAN_SK                     708
#define OBJ_EVENT_GFX_MARTIAL_ARTIST_SK          709
#define OBJ_EVENT_GFX_NERD_SK                    710
#define OBJ_EVENT_GFX_NURSE_JOY_SK               711
#define OBJ_EVENT_GFX_OLD_MAN2_SK                712
#define OBJ_EVENT_GFX_OLD_MAN_SK                 713
#define OBJ_EVENT_GFX_OLD_WOMAN2_SK              714
#define OBJ_EVENT_GFX_OLD_WOMAN_SK               715
#define OBJ_EVENT_GFX_PICNICKER_F_SK             716
#define OBJ_EVENT_GFX_PICNICKER_M_SK             717
#define OBJ_EVENT_GFX_POKE_FAN_SK                718
#define OBJ_EVENT_GFX_POKE_MANIAC_SK             719
#define OBJ_EVENT_GFX_PSYCHIC_M_SK               720
#define OBJ_EVENT_GFX_RANCHER_SK                 721
#define OBJ_EVENT_GFX_RANGER_F_SK                722
#define OBJ_EVENT_GFX_RANGER_M_SK                723
#define OBJ_EVENT_GFX_ROCKET_GRUNT_SK            724
#define OBJ_EVENT_GFX_RUIN_MANIAC_SK             725
#define OBJ_EVENT_GFX_SAILOR_SK                  726
#define OBJ_EVENT_GFX_SCIENTIST_M_SK             727
...
#define OBJ_EVENT_PAL_TAG_BLAINE_SK              0x1200
#define OBJ_EVENT_PAL_TAG_BLUE_SK                0x1201
#define OBJ_EVENT_PAL_TAG_BUGSY_SK               0x1202
#define OBJ_EVENT_PAL_TAG_ERIKA_SK               0x1203
#define OBJ_EVENT_PAL_TAG_FALKNER_SK             0x1204
#define OBJ_EVENT_PAL_TAG_GIOVANNI_SK            0x1205
#define OBJ_EVENT_PAL_TAG_SABRINA_SK             0x1206
#define OBJ_EVENT_PAL_TAG_WHITNEY_SK             0x1207
#define OBJ_EVENT_PAL_TAG_BROCK_SK               0x120d
#define OBJ_EVENT_PAL_TAG_JANINE_SK              0x121b
#define OBJ_EVENT_PAL_TAG_KOGA_SK                0x121c
#define OBJ_EVENT_PAL_TAG_MISTY_SK               0x1224
#define OBJ_EVENT_PAL_TAG_MORTY_SK               0x1225
#define OBJ_EVENT_PAL_TAG_NINJA_BOY_SK           0x1227
#define OBJ_EVENT_PAL_TAG_POKEKID_SK             0x1231
#define OBJ_EVENT_PAL_TAG_PSYCHIC_F_SK           0x1232
#define OBJ_EVENT_PAL_TAG_SAGE_SK                0x1239
#define OBJ_EVENT_PAL_TAG_SKIER_F_SK             0x123c
#define OBJ_EVENT_PAL_TAG_SKIER_M_SK             0x123d
#define OBJ_EVENT_PAL_TAG_TWINS_SK               0x123e
#define OBJ_EVENT_PAL_TAG_VETERAN_SK             0x123f
#define OBJ_EVENT_PAL_TAG_AARON_DP               0x1243
#define OBJ_EVENT_PAL_TAG_ACE_TRAINER_DP         0x1244
#define OBJ_EVENT_PAL_TAG_ACE_TRAINER_SNOW_M_DP  0x1245
#define OBJ_EVENT_PAL_TAG_BARRY_DP               0x1246
#define OBJ_EVENT_PAL_TAG_BATTLE_GIRL_DP         0x1247
#define OBJ_EVENT_PAL_TAG_BEAUTY_DP              0x1248
#define OBJ_EVENT_PAL_TAG_BERTHA_DP              0x1249
#define OBJ_EVENT_PAL_TAG_BLACK_BELT_DP          0x124a
#define OBJ_EVENT_PAL_TAG_BREEDER_F_DP           0x124b
#define OBJ_EVENT_PAL_TAG_BUG_CATCHER_DP         0x124c
#define OBJ_EVENT_PAL_TAG_BYRON_DP               0x124d
#define OBJ_EVENT_PAL_TAG_CAMPER_PICNICKER_DP    0x124e
#define OBJ_EVENT_PAL_TAG_CHARON_DP              0x124f
#define OBJ_EVENT_PAL_TAG_CHERYL_DP              0x1250
#define OBJ_EVENT_PAL_TAG_COWGIRL_DP             0x1251
#define OBJ_EVENT_PAL_TAG_CRASHER_WAKE_DP        0x1252
#define OBJ_EVENT_PAL_TAG_CYNTHIA_DP             0x1253
#define OBJ_EVENT_PAL_TAG_CYRUS_DP               0x1254
#define OBJ_EVENT_PAL_TAG_DRAGON_TAMER_DP        0x1255
#define OBJ_EVENT_PAL_TAG_FANTINA_DP             0x1256
#define OBJ_EVENT_PAL_TAG_FISHERMAN_DP           0x1257
#define OBJ_EVENT_PAL_TAG_GALACTIC_GRUNT_F_DP    0x1258
#define OBJ_EVENT_PAL_TAG_GALACTIC_GRUNT_M_DP    0x1259
#define OBJ_EVENT_PAL_TAG_GENTLEMAN_DP           0x125a
#define OBJ_EVENT_PAL_TAG_HIKER_DP               0x125b
#define OBJ_EVENT_PAL_TAG_JUPITER_DP             0x125c
#define OBJ_EVENT_PAL_TAG_LADY_DP                0x125d
#define OBJ_EVENT_PAL_TAG_LOOKER_DP              0x125e
#define OBJ_EVENT_PAL_TAG_LUCIAN_DP              0x125f
#define OBJ_EVENT_PAL_TAG_MARLEY_DP              0x1260
#define OBJ_EVENT_PAL_TAG_MARS_DP                0x1261
#define OBJ_EVENT_PAL_TAG_MAYLENE_DP             0x1262
#define OBJ_EVENT_PAL_TAG_MIRA_DP                0x1263
#define OBJ_EVENT_PAL_TAG_OFFICER_DP             0x1264
#define OBJ_EVENT_PAL_TAG_PAINTER_DP             0x1265
#define OBJ_EVENT_PAL_TAG_PALMER_DP              0x1266
#define OBJ_EVENT_PAL_TAG_PARASOL_LADY_DP        0x1267
#define OBJ_EVENT_PAL_TAG_POKE_KID_DP            0x1268
#define OBJ_EVENT_PAL_TAG_POKE_RANGER_DP         0x1269
#define OBJ_EVENT_PAL_TAG_POKEFAN_F_DP           0x126a
#define OBJ_EVENT_PAL_TAG_POKEFAN_M_DP           0x126b
#define OBJ_EVENT_PAL_TAG_PROF_ROWAN_DP          0x126c
#define OBJ_EVENT_PAL_TAG_PSYCHIC_DP             0x126d
#define OBJ_EVENT_PAL_TAG_RANCHER_DP             0x126e
#define OBJ_EVENT_PAL_TAG_RICH_BOY_DP            0x126f
#define OBJ_EVENT_PAL_TAG_RICH_LADY_DP           0x1270
#define OBJ_EVENT_PAL_TAG_ROCKER_DP              0x1271
#define OBJ_EVENT_PAL_TAG_ROUGHNECK_DP           0x1272
#define OBJ_EVENT_PAL_TAG_RUIN_MANIAC_DP         0x1273
#define OBJ_EVENT_PAL_TAG_SAILOR_DP              0x1274
#define OBJ_EVENT_PAL_TAG_SATURN_DP              0x1275
#define OBJ_EVENT_PAL_TAG_SCIENTIST_DP           0x1276
#define OBJ_EVENT_PAL_TAG_SKIER_F_DP             0x1277
#define OBJ_EVENT_PAL_TAG_SKIER_M_DP             0x1278
#define OBJ_EVENT_PAL_TAG_SOCIALITE_DP           0x1279
#define OBJ_EVENT_PAL_TAG_SUPERNERD_DP           0x127a
#define OBJ_EVENT_PAL_TAG_SWIMMER_F_DP           0x127b
#define OBJ_EVENT_PAL_TAG_SWIMMER_F2_DP          0x127c
#define OBJ_EVENT_PAL_TAG_SWIMMER_M_DP           0x127d
#define OBJ_EVENT_PAL_TAG_VOLKNER_DP             0x127e
#define OBJ_EVENT_PAL_TAG_WAITER_DP              0x127f
#define OBJ_EVENT_PAL_TAG_WAITRESS_DP            0x1280
#define OBJ_EVENT_PAL_TAG_WORKER_DP              0x1281
#define OBJ_EVENT_PAL_TAG_YOUNG_COUPLE_DP        0x1282
#define OBJ_EVENT_PAL_TAG_YOUNGSTER_DP           0x1283
#define OBJ_EVENT_PAL_TAG_ACE_TRAINER_F_SNOW_SK  0x1284
#define OBJ_EVENT_PAL_TAG_ACE_TRAINER_M_SK       0x1285
#define OBJ_EVENT_PAL_TAG_ACE_TRAINER_M_SNOW_SK  0x1286
#define OBJ_EVENT_PAL_TAG_BATTLE_GIRL_SK         0x1287
#define OBJ_EVENT_PAL_TAG_BREEDER_F_SK           0x1288
#define OBJ_EVENT_PAL_TAG_BUG_CATCHER_SK         0x1289
#define OBJ_EVENT_PAL_TAG_CLERK2_SK              0x128a
#define OBJ_EVENT_PAL_TAG_CLERK_SK               0x128b
#define OBJ_EVENT_PAL_TAG_COWGIRL_SK             0x128c
#define OBJ_EVENT_PAL_TAG_CUE_BALL_SK            0x128d
#define OBJ_EVENT_PAL_TAG_DRAGON_TAMER_SK        0x128e
#define OBJ_EVENT_PAL_TAG_FIREBREATHER_SK        0x128f
#define OBJ_EVENT_PAL_TAG_FISHERMAN_SK           0x1290
#define OBJ_EVENT_PAL_TAG_GAMER_SK               0x1291
#define OBJ_EVENT_PAL_TAG_GENTLEMAN_SK           0x1292
#define OBJ_EVENT_PAL_TAG_GIRL_SK                0x1293
#define OBJ_EVENT_PAL_TAG_GUARD_SK               0x1294
#define OBJ_EVENT_PAL_TAG_HIKER_SK               0x1295
#define OBJ_EVENT_PAL_TAG_LASS_SK                0x1296
#define OBJ_EVENT_PAL_TAG_LEAF_SK                0x1297
#define OBJ_EVENT_PAL_TAG_MAN2_SK                0x1298
#define OBJ_EVENT_PAL_TAG_MAN3_SK                0x1299
#define OBJ_EVENT_PAL_TAG_MAN4_SK                0x129a
#define OBJ_EVENT_PAL_TAG_MAN_SK                 0x129b
#define OBJ_EVENT_PAL_TAG_MARTIAL_ARTIST_SK      0x129c
#define OBJ_EVENT_PAL_TAG_NERD_SK                0x129d
#define OBJ_EVENT_PAL_TAG_NURSE_JOY_SK           0x129e
#define OBJ_EVENT_PAL_TAG_OLD_MAN2_SK            0x129f
#define OBJ_EVENT_PAL_TAG_OLD_MAN_SK             0x12a0
#define OBJ_EVENT_PAL_TAG_OLD_WOMAN2_SK          0x12a1
#define OBJ_EVENT_PAL_TAG_OLD_WOMAN_SK           0x12a2
#define OBJ_EVENT_PAL_TAG_PICNICKER_F_SK         0x12a3
#define OBJ_EVENT_PAL_TAG_PICNICKER_M_SK         0x12a4
#define OBJ_EVENT_PAL_TAG_POKE_FAN_SK            0x12a5
#define OBJ_EVENT_PAL_TAG_POKE_MANIAC_SK         0x12a6
#define OBJ_EVENT_PAL_TAG_PSYCHIC_M_SK           0x12a7
#define OBJ_EVENT_PAL_TAG_RANCHER_SK             0x12a8
#define OBJ_EVENT_PAL_TAG_RANGER_F_SK            0x12a9
#define OBJ_EVENT_PAL_TAG_RANGER_M_SK            0x12aa
#define OBJ_EVENT_PAL_TAG_ROCKET_GRUNT_SK        0x12ab
#define OBJ_EVENT_PAL_TAG_RUIN_MANIAC_SK         0x12ac
#define OBJ_EVENT_PAL_TAG_SAILOR_SK              0x12ad
#define OBJ_EVENT_PAL_TAG_SCIENTIST_M_SK         0x12ae
#define OBJ_EVENT_PAL_TAG_WOMAN4_SK              0x12af
#define OBJ_EVENT_PAL_TAG_WORKER_SK              0x12b0
#define OBJ_EVENT_PAL_TAG_YOUNGSTER_SK           0x12b1
...
#define OBJ_EVENT_PAL_TAG_STATUE                  0x116B // SK: Dedicated palette for the Trick House statue, split off from the shared NPC_4 palette
