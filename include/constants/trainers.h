...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_DP_ACE_TRAINER_DOUBLETEAM,
    TRAINER_PIC_FRONT_DP_ACE_TRAINER_F,
    TRAINER_PIC_FRONT_DP_ACE_TRAINER_M,
    TRAINER_PIC_FRONT_DP_ACE_TRAINER_SNOW_F,
    TRAINER_PIC_FRONT_DP_ACE_TRAINER_SNOW_M,
    TRAINER_PIC_FRONT_DP_AROMA_LADY,
    TRAINER_PIC_FRONT_DP_BARRY,
    TRAINER_PIC_FRONT_DP_BATTLE_GIRL,
    TRAINER_PIC_FRONT_DP_BEAUTY,
    TRAINER_PIC_FRONT_DP_BERTHA,
    TRAINER_PIC_FRONT_DP_BIRD_KEEPER,
    TRAINER_PIC_FRONT_DP_BLACK_BELT,
    TRAINER_PIC_FRONT_DP_BREEDER_F,
    TRAINER_PIC_FRONT_DP_BREEDER_M,
    TRAINER_PIC_FRONT_DP_BUCK,
    TRAINER_PIC_FRONT_DP_BUG_CATCHER,
    TRAINER_PIC_FRONT_DP_BYRON,
    TRAINER_PIC_FRONT_DP_CAMERAMAN,
    TRAINER_PIC_FRONT_DP_CAMPER,
    TRAINER_PIC_FRONT_DP_CANDICE,
    TRAINER_PIC_FRONT_DP_CHERYL,
    TRAINER_PIC_FRONT_DP_CLOWN,
    TRAINER_PIC_FRONT_DP_COLLECTOR,
    TRAINER_PIC_FRONT_DP_COWGIRL,
    TRAINER_PIC_FRONT_DP_CRASHER_WAKE,
    TRAINER_PIC_FRONT_DP_CYCLIST_F,
    TRAINER_PIC_FRONT_DP_CYCLIST_M,
    TRAINER_PIC_FRONT_DP_CYNTHIA,
    TRAINER_PIC_FRONT_DP_CYRUS,
    TRAINER_PIC_FRONT_DP_DAWN,
    TRAINER_PIC_FRONT_DP_DRAGON_TAMER,
    TRAINER_PIC_FRONT_DP_FANTINA,
    TRAINER_PIC_FRONT_DP_FISHERMAN,
    TRAINER_PIC_FRONT_DP_GALACTIC_GRUNT_DUO_MM,
    TRAINER_PIC_FRONT_DP_GALACTIC_GRUNT_F,
    TRAINER_PIC_FRONT_DP_GALACTIC_GRUNT_M,
    TRAINER_PIC_FRONT_DP_GAMBLER,
    TRAINER_PIC_FRONT_DP_GARDENIA,
    TRAINER_PIC_FRONT_DP_GENTLEMAN,
    TRAINER_PIC_FRONT_DP_HIKER,
    TRAINER_PIC_FRONT_DP_IDOL,
    TRAINER_PIC_FRONT_DP_INTERVIEWERS,
    TRAINER_PIC_FRONT_DP_JOGGER,
    TRAINER_PIC_FRONT_DP_JUPITER,
    TRAINER_PIC_FRONT_DP_LADY,
    TRAINER_PIC_FRONT_DP_LASS,
    TRAINER_PIC_FRONT_DP_LUCAS,
    TRAINER_PIC_FRONT_DP_LUCIAN,
    TRAINER_PIC_FRONT_DP_MARLEY,
    TRAINER_PIC_FRONT_DP_MARS,
    TRAINER_PIC_FRONT_DP_MAYLENE,
    TRAINER_PIC_FRONT_DP_MIRA,
    TRAINER_PIC_FRONT_DP_NINJA_BOY,
    TRAINER_PIC_FRONT_DP_OFFICER,
    TRAINER_PIC_FRONT_DP_PAINTER_ARTIST,
    TRAINER_PIC_FRONT_DP_PALMER,
    TRAINER_PIC_FRONT_DP_PARASOL_LADY,
    TRAINER_PIC_FRONT_DP_PICNICKER,
    TRAINER_PIC_FRONT_DP_POKE_KID,
    TRAINER_PIC_FRONT_DP_POKEFAN_F,
    TRAINER_PIC_FRONT_DP_POKEFAN_M,
    TRAINER_PIC_FRONT_DP_POKEMON_RANGER_F,
    TRAINER_PIC_FRONT_DP_POKEMON_RANGER_M,
    TRAINER_PIC_FRONT_DP_PSYCHIC_F,
    TRAINER_PIC_FRONT_DP_PSYCHIC_M,
    TRAINER_PIC_FRONT_DP_RANCHER,
    TRAINER_PIC_FRONT_DP_RANCHER_DUO_BELLE_AND_PA,
    TRAINER_PIC_FRONT_DP_REPORTER,
    TRAINER_PIC_FRONT_DP_RICH_BOY,
    TRAINER_PIC_FRONT_DP_RILEY,
    TRAINER_PIC_FRONT_DP_ROARK,
    TRAINER_PIC_FRONT_DP_ROCKER_GUITARIST,
    TRAINER_PIC_FRONT_DP_ROUGHNECK,
    TRAINER_PIC_FRONT_DP_RUIN_MANIAC,
    TRAINER_PIC_FRONT_DP_SAILOR,
    TRAINER_PIC_FRONT_DP_SATURN,
    TRAINER_PIC_FRONT_DP_SCHOOL_KID_F,
    TRAINER_PIC_FRONT_DP_SCHOOL_KID_M,
    TRAINER_PIC_FRONT_DP_SCIENTIST,
    TRAINER_PIC_FRONT_DP_SKIER_F,
    TRAINER_PIC_FRONT_DP_SKIER_M,
    TRAINER_PIC_FRONT_DP_SOCIALITE,
    TRAINER_PIC_FRONT_DP_SWIMMER_F,
    TRAINER_PIC_FRONT_DP_SWIMMER_M,
    TRAINER_PIC_FRONT_DP_TUBER_F,
    TRAINER_PIC_FRONT_DP_TUBER_M,
    TRAINER_PIC_FRONT_DP_TWINS,
    TRAINER_PIC_FRONT_DP_VETERAN,
    TRAINER_PIC_FRONT_DP_VOLKNER,
    TRAINER_PIC_FRONT_DP_WAITER,
    TRAINER_PIC_FRONT_DP_WAITRESS,
    TRAINER_PIC_FRONT_DP_WORKER,
    TRAINER_PIC_FRONT_DP_YOUNG_COUPLE,
    TRAINER_PIC_FRONT_DP_YOUNGSTER,
